...
namespace Lab62
{
    class Program
    {
        ...
        public class ForInspection
        {
            ...
            public ForInspection(string str, double d) { }
            public int Plus(int x, int y) { return x + y; }
            public int Minus(int x, int y) { return x - y; }
            public double Average(int x, int y) { return (double)(x + y) / 2; }
        ...
        static void Main()
        {
            ...
            object Result = t.InvokeMember("Average", BindingFlags.InvokeMethod, null, fi, parameters);
